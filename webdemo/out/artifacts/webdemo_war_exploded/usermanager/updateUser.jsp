...
<div class="formbody">
    ...
    <ul class="forminfo">
        ...
        <li>
            ...
            <input name="typeInfo" type="radio" value="1" checked="checked" />高级管理员
            <input name="typeInfo" type="radio" value="2" />中级管理员
            <input name="typeInfo" type="radio" value="3" />普通管理员
            </c:when>
            <c:otherwise>
                <input name="typeInfo" type="radio" value="1"  />高级管理员
                <input name="typeInfo" type="radio" value="2" checked="checked"/>中级管理员
                <input name="typeInfo" type="radio" value="3" />普通管理员
            </c:otherwise>
            </c:choose>
